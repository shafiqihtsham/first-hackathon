const nodes = [
  ...
  },
  {
    ...
    isEnd: false,
    factText: "Publicising information that could create fear and negative feelings in the public must be managed alongside assuring news of plans and solutions"
  },
  {
    id: "CountriesA",
    description:
  ...
  },
  {
    ...
    isEnd: false,
    factText: "The earlier that action is made, the less needs to be done to change an objects path in space\nA very minor nudge could result in an object passing by harmlessly millions of kilometers away instead of colliding with the earth, if done many years/orbits ahead of schedule"
  },
  {
    id: "devA",
    description: "Development begins...",
    isEnd: false,
    factText: "This Asteroid takes about 4.5 years to go around the sun, it is often safer and more efficient to wait for particular times in their orbital path to launch a probe and plan maneuvers."
  },
  {
    id: "launch",
    description: "Launch!",
